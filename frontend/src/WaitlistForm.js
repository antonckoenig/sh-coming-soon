  ...
  return (
    <div className='absolute w-full h-full 2xl:pl-24 2xl:pt-24 xl:pl-20 xl:pt-20 lg:pl-16 lg:pt-16 md:pl-12 md:pt-12 sm:pl-8 sm:pt-8 wd:pt-8 sh:pt-0 pl-6 pt-6 pr-6'>
      ...
      <div className='2xl:mt-12 sh:mt-8 mt-10 flex 2xl:h-[4.5rem] lg:h-16 sm:h-14 sh:h-12 h-14 lg:w-fit rounded-xl'>
        <input className='bg-white/25 backdrop-blur-md text-white placeholder-white/75 outline-0 2xl:w-96 sm:w-80 w-full h-full 2xl:px-7 lg:px-6 px-4 rounded-l-xl rounded-r-none 2xl:text-xl lg:text-lg text-base border-solid border-white/30 border-2 border-r-0' placeholder={width >= 325 ? 'Enter your email' : 'Email'} value={email} onChange={(e) => setEmail(e.target.value)}/>
