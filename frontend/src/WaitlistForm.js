...
function WaitlistForm({animate}) {
  ...
  return (
    <div className='absolute w-full h-full 2xl:pl-24 2xl:pt-24 xl:pl-20 xl:pt-20 lg:pl-16 lg:pt-16 md:pl-12 md:pt-12 sm:pl-8 sm:pt-8 wd:pt-8 sh:pt-6 pl-6 pt-6 pr-6'>
      ...
      <p className='2xl:mt-6 lg:mt-5 sm:mt-4 mt-3 text-white/80 2xl:text-2xl sm:text-xl sh:text-lg text-lg'>A community investment app powered by Web3.</p>
      <div className='2xl:mt-12 mt-10 flex 2xl:h-[4.5rem] lg:h-16 sm:h-14 sh:h-12 h-12 lg:w-fit rounded-xl'>
