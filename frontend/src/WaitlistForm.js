...
function WaitlistForm({animate}) {
  ...
  return (
    <div className='absolute w-full h-full 2xl:pl-24 2xl:pt-24 xl:pl-20 xl:pt-20 lg:pl-16 lg:pt-16 md:pl-12 md:pt-12 sm:pl-8 sm:pt-8 wd:pt-8 sh:pt-0 pl-6 pt-6 pr-6'>
      <p className='text-white 2xl:text-7xl lg:text-6xl sm:text-5xl xs:text-4xl wd:text-5xl sh:text-3xl text-3xl inline-block'>Invest in&nbsp;</p>
      <p className={`text-white 2xl:text-7xl lg:text-6xl sm:text-5xl xs:text-4xl wd:text-5xl sh:text-3xl text-3xl font-bold inline-block ${animate && 'animate-text-paragraph'}`} />
